...
# Rellenar el archivo
  ...
  echo '        <file description="Custom" url="inline::rules/entrante-no-solicitado.rules">hacks4geeks.rules</file>'  >> /usr/local/opnsense/scripts/suricata/metadata/rules/hacks4geeks.xml
  echo '    </files>'                                                                                                  >> /usr/local/opnsense/scripts/suricata/metadata/rules/hacks4geeks.xml
